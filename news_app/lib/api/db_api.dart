...
import 'package:news_app/user_data.dart';
...
''');
  ...
  Future<InterestsData?> getInterests() async {
    ...
    return InterestsData.fromMap(maps[0].cast<String, String>());
  }
...
class SupabaseDBApi extends DBApi {
  ...
  Future<InterestsData?> getInterests() async {
    final data =
        await Supabase.instance.client.from('interests').select().single();

    return InterestsData.fromMap(Map<String, String>.from(data));
  }
