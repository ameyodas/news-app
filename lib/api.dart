...
//     debugPrint('srcLink: $srcLink');

//     for (int tryNo = 0; tryNo < numTries; ++tryNo) {
//       if (_cache.containsKey(data) && !forceFetch) {
//         debugPrint('returning cached summary');
//         return Future.value(_cache[data]?['summary']);
//       }
...
//         _cache[data] = {'summary': summary, 'cleaned_summary': cleanedSummary};
